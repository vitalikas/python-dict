...
for flower in flowers.values(): 
    for param in flower['sepal_length']:
        sum_sepal_length = sum_sepal_length + param
        count_values_sepal_length = count_values_sepal_length + 1
    for param in flower['sepal_width']:
        sum_sepal_width = sum_sepal_width + param
        count_values_sepal_width = count_values_sepal_width + 1
    for param in flower['petal_length']:
        sum_petal_length = sum_petal_length + param
